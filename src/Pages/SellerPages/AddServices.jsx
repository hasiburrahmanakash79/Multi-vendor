...
//     location: "",
//   });
//   const [coverFile, setCoverFile] = useState(null); // Store file object
//   const [portfolioFiles, setPortfolioFiles] = useState([]); // Store file objects
...
//   const addAdditional = () => {
//     // Validate that fields are non-empty strings and image is a File
//     if (
...
//       return;
//     }
//     console.log("Adding additional:", newAdditional); // Debug
...
//       return;
//     }
//     console.log("Adding benefit:", newBenefit); // Debug
...
//         icon: "error",
//         title: "Validation Error",
//         text: "All fields (Title, Description, Category, Place ID, Latitude, Longitude, Price, Time From, Time To, Location, Cover Photo, and at least one Portfolio image) are required.",
//         toast: true,
//         position: "top-end",
//         showConfirmButton: false,
//         timer: 3000,
...
//       formDataToSend.append("portfolio_photos", file); // Array of files
//     });

//     // Append additionals with correct nesting
...
//     // Append benefits with correct nesting
...
//       <div className="bg-black rounded-xl shadow-lg w-full max-w-3xl mx-auto p-6">
...
//                     className="absolute top-1 right-1 bg-red-500 text-black rounded-full w-6 h-6 flex items-center justify-center hover:bg-red-700 transition-colors"
//                   >
//                     &times;
//                   </button>
//                 </div>
...
//                 </label>
//                 <div
//                   className="relative border-2 border-dashed border-gray-300 rounded-lg p-4 text-center cursor-pointer hover:border-purple-500"
...
const AddServices = () => {
  ...
  const [formData, setFormData] = useState({
    title: "",
    description: "",
    category: "", // Changed to empty string for default select
    place_id: "",
    latitude: "",
    longitude: "",
    price: "",
      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-6xl mx-auto p-6 sm:p-8 transform transition-all duration-300">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4">
            ...
            <button
              onClick={handleSubmit}
              className="px-6 py-3 bg-[#c8c1f5] text-gray-600 rounded-full hover:bg-[#beb6f5] transition-colors duration-200 font-semibold"
            >
              Submit
            </button>
          </div>
